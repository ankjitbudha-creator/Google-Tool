        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
                ...
                <Link href="/all-tools" className="inline-flex items-center gap-3 bg-accent hover:bg-accent-hover text-gray-900 font-bold px-8 py-4 rounded-full text-lg transition-transform hover:scale-105">
       ...
       <section className="py-20">
          <div className="container mx-auto px-6">
              ...
              <div className="text-center mt-12">
                  <Link href="/all-tools" className="px-8 py-3 text-white font-semibold bg-primary rounded-full hover:bg-primary-hover transition-colors duration-300">
                    View All Tools
                  </Link>
              </div>
          </div>
