...
export const ScaleIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 20.25a7.5 7.5 0 0 0-7.5-7.5v-7.5a7.5 7.5 0 0 0-7.5 7.5h7.5Z" />
  </svg>
);
...
export const BeakerIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c.238.15.487.31.74.485m.74-.485a2.25 2.25 0 0 0 2.5.433m2.5-.433c.253.175.506.35.759.539m.759-.539a2.25 2.25 0 0 1 2.5.433m2.5-.433a2.25 2.25 0 0 0 0 4.5m-15-4.5a2.25 2.25 0 0 0 0 4.5m15-4.5a2.25 2.25 0 0 1 0 4.5m-15-4.5a2.25 2.25 0 0 1 0 4.5m15-4.5a2.25 2.25 0 0 0 0-4.5m-15-4.5a2.25 2.25 0 0 0 0-4.5M3 14.25l3.879-3.879a2.25 2.25 0 0 1 1.591-.659h5.058a2.25 2.25 0 0 1 1.591.659L21 14.25M3 14.25v2.25a2.25 2.25 0 0 0 2.25 2.25h13.5A2.25 2.25 0 0 0 21 16.5v-2.25" />
  </svg>
);
...
export const CakeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 15.75a.75.75 0 0 1-.75.75H3.75a.75.75 0 0 1-.75-.75V14.25m18 1.5V12a2.25 2.25 0 0 0-2.25-2.25H15a2.25 2.25 0 0 0-2.25 2.25v3.75m-1.5-3.75V9.75a2.25 2.25 0 0 0-2.25-2.25h-.142c-.622 0-1.223.24-1.68.664L9 10.5m-1.5 3.75v-2.25a2.25 2.25 0 0 0-2.25-2.25H3.75M3 12h3.75m9 3.75h3.75" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25v4.5m0-4.5c.33.02.66.029 1 .05m-1-.05c-.34-.02-.67-.03-1-.05m1 .05s-1.5-.75-1.5-1.5V9a1.5 1.5 0 0 1 1.5-1.5h.09a1.5 1.5 0 0 1 1.41 1.5v3.8Z" />
    </svg>
);
...
export const RocketLaunchIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 1.16a1.5 1.5 0 0 1 2.12 0l1.2 1.2a1.5 1.5 0 0 1 0 2.12l-8.62 8.62a1.5 1.5 0 0 1-2.12 0l-1.2-1.2a1.5 1.5 0 0 1 0-2.12l8.62-8.62Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m12 2.25 1.88 1.88-6.36 6.36L5.64 8.62 12 2.25Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25a9.75 9.75 0 0 1 9.75 9.75c0 1.95-.57 3.77-1.53 5.25A9.75 9.75 0 0 1 12 21.75 9.75 9.75 0 0 1 2.25 12 9.75 9.75 0 0 1 12 2.25Z" />
    </svg>
);
...
export const LightBulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c.065.21.145.421.24.631a2.25 2.25 0 0 0 4.134 1.255 2.25 2.25 0 0 0 4.134-1.255c.095-.21.175-.421.24-.631Zm-7.5-3.841a6.756 6.756 0 0 1 4.5 0" />
    </svg>
);
...
export const TrophyIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 0 1 9 0Zm-4.5-3.75a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 0 1.5h-3a.75.75 0 0 1-.75-.75Zm-6 0a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 0 1.5H6a.75.75 0 0 1-.75-.75Zm1.5-4.5a.75.75 0 0 0-.75.75v3a.75.75 0 0 0 1.5 0v-3a.75.75 0 0 0-.75-.75Zm6.75-3a.75.75 0 0 0-.75.75v3a.75.75 0 0 0 1.5 0v-3a.75.75 0 0 0-.75-.75Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V10.5M4.5 10.5h15" />
    </svg>
);
...
export const WrenchScrewdriverIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75a4.5 4.5 0 0 1-4.884 4.484c-1.076-.091-2.216-.384-3.235-.853A4.5 4.5 0 0 1 6.75 6.75c1.076.091 2.216.384 3.235.853a4.5 4.5 0 0 1 4.884 4.484 4.5 4.5 0 0 1-4.884 4.484c-1.076-.091-2.216-.384-3.235-.853a4.5 4.5 0 0 1-4.884-4.484A4.5 4.5 0 0 1 6.75 6.75c1.076.091 2.216.384 3.235.853a4.5 4.5 0 0 1 4.884 4.484" />
    </svg>
);
...
export const ArrowPathIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001a10.5 10.5 0 0 0-9.282-8.622 10.5 10.5 0 0 0-11.233 11.233c0 2.457.85 4.733 2.37 6.556l-2.07 2.07a1.5 1.5 0 0 0 2.122 2.122l2.07-2.07c1.823 1.52 4.1 2.37 6.556 2.37 6.21 0 11.25-5.04 11.25-11.25 0-2.04-.55-3.95-1.5-5.652v4.992Z" />
    </svg>
);
...
export const DocumentDuplicateIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5.124m7.5 10.375a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Zm0 0c0 1.657-1.007 3-2.25 3S11.25 19.407 11.25 17.75s1.007-3 2.25-3 2.25 1.343 2.25 3Z" />
    </svg>
);
...
export const MoonIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25c0 5.385 4.365 9.75 9.75 9.75 2.572 0 4.921-.996 6.702-2.634Z" />
    </svg>
);
...
export const LockOpenIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 0 0-9 0v3.75m0 0L3 10.5m0 0a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25m-4.5 0L9 10.5" />
  </svg>
);
...
export const ArrowUturnRightIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const DocumentArrowDownIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m-1.5 9 3 3m0 0 3-3m-3 3v-6m-1.5-9H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
    </svg>
);

export const DocumentPlusIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m3.75 9v6m3-3h-6m-1.5-9H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
    </svg>
);

export const ScissorsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.875 14.25l1.214 1.214a.75.75 0 0 0 1.06 0l4.286-4.286a.75.75 0 0 1 1.06 0l1.214 1.214m-1.06-1.06-4.286-4.286a.75.75 0 0 0-1.06 0l-4.286 4.286a.75.75 0 0 0 0 1.06l4.286 4.286a.75.75 0 0 0 1.06 0Zm-3.75-3.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm12 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
);

export const EncoderIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const GlobeAltIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9h16.5M3.75 15h16.5M9 3.75a13.9 13.9 0 0 1 6 0M15 20.25a13.9 13.9 0 0 1-6 0" />
    </svg>
);
...
export const XSocialIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 7.184L18.901 1.153ZM17.61 20.644h2.039L6.486 3.24H4.298l13.312 17.404Z"/>
    </svg>
);
