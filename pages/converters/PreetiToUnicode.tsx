...
const convertPreetiToUnicode = (preetiText: string): string => {
    ...
    const preetiToUnicodeMap = {
        ...
        '+': 'ं', '=': 'रु', '-': ']', '[': 'v', ']': ']', '{': 'V', '}': '}', ';': 'स', ':': 'स्', "'": 'र्',
        '"': 'र', ',': 'ठ', '<': 'ठ', '.': 'ड', '>': 'ड्', '/': 'र', '?': 'रु', '`': '~', '~': '`',
        'cf': 'ि', 'c': 'अ', 'C': 'ऋ', 'D': 'ः', 'f': 'ा', 'F': 'ँ', 'h': 'ज', 'H': 'ज्', 'i': 'ष्', 'I': 'क्ष्',
        'j': 'व्', 'J': 'इ', 'l': 'ि', 'L': 'ी', 'o': 'य', 'O': 'इ', 'p': 'उ', 'P': 'ऊ', 'q': 'त्र', 'Q': 'त्त',
        '|': '।', '||': '।।'
    };
    
    // A more complex logic is needed for accurate conversion.
    // The provided map is a starting point. Let's use a more robust function.
    ...
    // Post-processing to handle matras (this is very basic)
